package debug;
/******************************************************************************
 *  Compilation:  javac debug.StdDraw.java
 *  Execution:    java debug.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code debug.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code debug.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">debug.StdDraw.java</a>
 ...
 *           debug.StdDraw.setPenRadius(0.05);
 *           debug.StdDraw.setPenColor(debug.StdDraw.BLUE);
 *           debug.StdDraw.point(0.5, 0.5);
 *           debug.StdDraw.setPenColor(debug.StdDraw.MAGENTA);
 *           debug.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code debug.StdDraw.line()} and {@code debug.StdDraw.point()}
 *  draw lines and points; the methods {@code debug.StdDraw.setPenRadius()}
 *  and {@code debug.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code debug.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   debug.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code debug.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code debug.StdDraw.setPenColor(debug.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code debug.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code debug.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   debug.StdDraw.setFont(font);
 *   debug.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code debug.StdDraw.clear(debug.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   debug.StdDraw.setScale(-2, +2);
 *   debug.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       debug.StdDraw.clear();
 *       debug.StdDraw.filledCircle(x, y, 0.05);
 *       debug.StdDraw.filledCircle(-x, -y, 0.05);
 *       debug.StdDraw.show();
 *       debug.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code debug.StdDraw.BLACK}, {@code debug.StdDraw.BLUE}, {@code debug.StdDraw.CYAN},
	 * {@code debug.StdDraw.DARK_GRAY}, {@code debug.StdDraw.GRAY}, {@code debug.StdDraw.GREEN},
	 * {@code debug.StdDraw.LIGHT_GRAY}, {@code debug.StdDraw.MAGENTA}, {@code debug.StdDraw.ORANGE},
	 * {@code debug.StdDraw.PINK}, {@code debug.StdDraw.RED}, {@code debug.StdDraw.WHITE}, and
	 * {@code debug.StdDraw.YELLOW}.
	 *
	...
	private static Image getImage(String filename) {
		...
		// in case file is inside a .jar (classpath relative to debug.StdDraw)
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to debug.StdDraw)
        try {
            URL url = debug.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
